...
var parser=(function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c45 = function(statement) {
          return statement
        },
        peg$c46 = "elif",
        peg$c47 = { type: "literal", value: "elif", description: "\"elif\"" },
        peg$c48 = function(test, body) {
          return {
            type: 'ifElse',
            test: test,
            body: body
        ...
        peg$c49 = { type: "other", description: "a while/until loop" },
        peg$c50 = "while",
        peg$c51 = { type: "literal", value: "while", description: "\"while\"" },
        peg$c52 = "until",
        peg$c53 = { type: "literal", value: "until", description: "\"until\"" },
        peg$c54 = "do",
        peg$c55 = { type: "literal", value: "do", description: "\"do\"" },
        peg$c56 = "done",
        peg$c57 = { type: "literal", value: "done", description: "\"done\"" },
        peg$c58 = function(kind, test, body) {
          return {
            type: kind + 'Loop',
            test: test,
            body: body
        ...
        peg$c59 = { type: "other", description: "a for loop" },
        peg$c60 = "for",
        ...
        peg$c66 = function(loopVar, subjects, body) {
          return {
            type: 'forLoop',
        ...
        peg$c67 = { type: "other", description: "time builtin" },
        peg$c68 = "time",
        peg$c69 = { type: "literal", value: "time", description: "\"time\"" },
        peg$c70 = "-",
        peg$c71 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c72 = /^[a-z]/,
        peg$c73 = { type: "class", value: "[a-z]", description: "[a-z]" },
        peg$c74 = function(flags, statements) {
          return {
            type: 'time',
            flags: flags,
            command: statements
        ...
        peg$c75 = { type: "other", description: "declare builtin" },
        peg$c76 = "declare",
        peg$c77 = { type: "literal", value: "declare", description: "\"declare\"" },
        peg$c78 = "typeset",
        peg$c79 = { type: "literal", value: "typeset", description: "\"typeset\"" },
        peg$c80 = /^[^\n]/,
        peg$c81 = { type: "class", value: "[^\\n]", description: "[^\\n]" },
        peg$c82 = { type: "other", description: "a variable assignment" },
        peg$c83 = "=",
        peg$c84 = { type: "literal", value: "=", description: "\"=\"" },
        peg$c85 = function(name, value) {
          return {type: 'variableAssignment', name: name, value: value}
        },
        peg$c86 = { type: "other", description: "command name" },
        peg$c87 = function(name) {
          return name
        },
        peg$c88 = "[[",
        peg$c89 = { type: "literal", value: "[[", description: "\"[[\"" },
        peg$c90 = { type: "other", description: "command argument" },
        peg$c91 = { type: "other", description: "concatenation of strings and/or variables" },
        peg$c92 = function(pieces) {
          return flattenConcatenation(pieces)
        },
        peg$c93 = { type: "other", description: "bareword" },
        peg$c94 = "#",
        peg$c95 = { type: "literal", value: "#", description: "\"#\"" },
        peg$c96 = function(cs) { return literal(cs) },
        peg$c97 = "\\",
        peg$c98 = { type: "literal", value: "\\", description: "\"\\\\\"" },
        peg$c99 = function(chr) { return chr },
        ...
        peg$c120 = function(inner) { return literal(inner) },
        peg$c121 = "\"",
        peg$c122 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c123 = function(contents) {
        ...
        peg$c140 = function(commands) {
          return {
            type: 'commandSubstitution',
            commands: commands
          }
        },
        peg$c141 = function(input) {
        ...
        peg$c154 = function(fd, op, filename) {
          if (fd == null) fd = op[0] == '<' ? 0 : 1;
          return {
            type: 'redirectFd',
            fd: fd,
        ...
        peg$c169 = function(digits) { return parseInt(join(digits), 10) },
        peg$c170 = "&",
        peg$c171 = { type: "literal", value: "&", description: "\"&\"" },
        peg$c172 = ";;",
        peg$c173 = { type: "literal", value: ";;", description: "\";;\"" },
        peg$c174 = function(op) {
          return op == '\n' ? ';' : op
        },
        peg$c175 = function(command) {
        ...
        peg$c181 = { type: "other", description: "a comment" },
